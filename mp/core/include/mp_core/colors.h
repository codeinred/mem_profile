...
#define MP_COLOR_BBl "\033[90m"
#define MP_COLOR_BR "\033[91m"
#define MP_COLOR_BG "\033[92m"
#define MP_COLOR_BY "\033[93m"
#define MP_COLOR_BB "\033[94m"
#define MP_COLOR_BM "\033[95m"
#define MP_COLOR_BC "\033[96m"
#define MP_COLOR_BW "\033[97m"
...
constexpr char BBl[] = "\033[90m"; ///< Fg: Bright Bold Black
constexpr char BR[]  = "\033[91m"; ///< Fg: Bright Bold Red
constexpr char BG[]  = "\033[92m"; ///< Fg: Bright Bold Green
constexpr char BY[]  = "\033[93m"; ///< Fg: Bright Bold Yellow
constexpr char BB[]  = "\033[94m"; ///< Fg: Bright Bold Blue
constexpr char BM[]  = "\033[95m"; ///< Fg: Bright Bold Magenta
constexpr char BC[]  = "\033[96m"; ///< Fg: Bright Bold Cyan
constexpr char BW[]  = "\033[97m"; ///< Fg: Bright Bold White
} // namespace mp::colors
